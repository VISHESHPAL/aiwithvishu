...
export default function PageContent({ page, darkMode, onSavePage }) {
  ...
  // Helper to render content with image + prompt layout
  ...
  // Render Video Section with Image + Prompt
  const renderVideoSection = (text, index) => {
    const lines = text.split('\n');
    const title = lines[0].replace(/^###\s*/, '').trim();
    const content = lines.slice(1).join('\n').trim();

    // Extract prompt text (between quotes or after "VIDEO PROMPT")
    ...
    return (
      <div key={index} className="my-6">
        ...
        {/* Image + Prompt Layout - Image on top, prompt below */}
      ...
      >
        ...
        <div className="flex justify-between items-center pb-4 mb-6 border-b border-slate-100 dark:border-neutral-800">
          <div className="flex items-center gap-2">
            <div className="p-2 bg-sky-50 dark:bg-neutral-850 text-sky-600 dark:text-sky-400">
            ...
            <div>
              {isEditing ? (
                <input
                  ...
                  className={`font-black text-xl md:text-2xl bg-transparent border-b border-sky-500 focus:outline-none ${
        ...
        {isEditing ? (
          <div className="flex flex-col gap-4 text-xs md:text-sm">
            <div className="flex flex-col gap-1">
              ...
              <textarea
                ...
                rows={12}
                className={`w-full font-mono p-3 border focus:outline-none focus:ring-1 focus:ring-sky-600 ${
                  darkMode
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="flex flex-col gap-1">
                ...
                <input
                  ...
                  className={`w-full px-3 py-2 border focus:outline-none focus:ring-1 focus:ring-sky-600 ${
                    darkMode
            ...
            <button
              onClick={handleSave}
              className="bg-sky-600 hover:bg-sky-700 text-white py-2.5 font-bold uppercase tracking-wider text-xs transition-colors self-start px-6"
            >
              Apply Page Updates
            </button>
          </div>
          ...
          <div className="flex flex-col gap-2">
            {/* Formatted body with image+prompt layout */}
            ...
            {(page.email || page.phone) && (
              <div className="mt-6 pt-6 border-t border-slate-100 dark:border-neutral-800 grid grid-cols-1 sm:grid-cols-2 gap-4">
                {page.email && (
                  ...
                  >
                    <div className="p-2.5 bg-sky-50 dark:bg-neutral-850 text-sky-600 dark:text-sky-400 rounded-full">
